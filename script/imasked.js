...
window.addEventListener("DOMContentLoaded", function() {
    ...
    function setCssForAccept() {
        ...
        form .icon-check{`+cssVarCode+`position:absolute;top:50%;right:0;width:1em;height:.5em;border-left:2px solid var(--check-mark-color);border-bottom:2px solid var(--check-mark-color);transform:translate(0, -50%) rotate(-45deg);opacity:0}
